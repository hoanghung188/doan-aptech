<%-- 
    Document   : index
    Created on : Jun 12, 2020, 7:02:16 PM
    Author     : doanv
--%>
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 col-xs-6">
                        <div class="shop">
                            <div class="shop-img">
                                <img src="<c:url value='views'/>/img/shop01.png" alt="">
                            </div>
                            <div class="shop-body">
                                <h3>Laptop</h3>
                    ...
                    <div class="col-md-4 col-xs-6">
                        <div class="shop">
                            <div class="shop-img">
                                <img src="<c:url value='views'/>/img/shop03.png" alt="">
                            </div>
                            <div class="shop-body">
                                <h3>Phụ kiện</h3>
                                <a href="#" class="cta-btn">Shop now <i class="fa fa-arrow-circle-right"></i></a>
                    ...
                    <div class="col-md-4 col-xs-6">
                        <div class="shop">
                            <div class="shop-img">
                                <img src="<c:url value='views'/>/img/shop02.png" alt="">
                            </div>
                            <div class="shop-body">
                                <h3>Cameras</h3>
                                <a href="#" class="cta-btn">Shop now <i class="fa fa-arrow-circle-right"></i></a>
                                ...
                                <div id="tab1" class="tab-pane active">
                                  ...
                                  <c:forEach items="${listBanChay}" var="p">
                                     <!-- product -->
                                             <div class="product">
                                            <div class="product-img">
                                                <img src="<c:url value='views'/>/img/${p.anhDaiDien}" alt="">
                                            ...
                                            <div class="product-body">
                                                <p class="product-category">${p.tenSanPham}</p>
                                                <h3 class="product-name"><a href="#">${p.tenSanPham}</a></h3>
                                                <h4 class="product-price"><fmt:formatNumber value="${p.gia}"/> <del class="product-old-price"><fmt:formatNumber value="${p.gia}"/></del></h4>
                                                ...
                                                <div class="product-btns">
                                                    <button class="add-to-wishlist"><i class="fa fa-heart-o"></i><span class="tooltipp">Thêm vào mục ưa thích</span></button>
                                                    <button class="add-to-compare"><i class="fa fa-exchange"></i><span class="tooltipp">Thêm vào giỏ hàng</span></button>
                                                    <button class="quick-view"><i class="fa fa-eye"></i><span class="tooltipp">xem lại/span></button>
                                                </div>
                                            </div>
                            ...
                            <div class="products-tabs">
                                ...
                                <div id="tab2" class="tab-pane fade in active">
                                    <div class="products-slick" data-nav="#slick-nav-2">
                                        ...
                                        <div class="product">
                                            <div class="product-img">
                                                <img src="<c:url value='views'/>/img/product06.png" alt="">
                                                <div class="product-label">
                                                    <span class="sale">-30%</span>
                                                    <span class="new">NEW</span>
                                                </div>
                    ...
                    <div class="col-md-4 col-xs-6">
                        ...
                        <div class="products-widget-slick" data-nav="#slick-nav-3">
                            <div>
                                ...
                                <div class="product-widget">
                                    <div class="product-img">
                                        <img src="<c:url value='views'/>/img/product07.png" alt="">
                                    </div>
                                    <div class="product-body">
                                        <p class="product-category">Category</p>
                                        <h3 class="product-name"><a href="#">product name goes here</a></h3>
                                ...
                                <div class="product-widget">
                                    <div class="product-img">
                                        <img src="<c:url value='views'/>/img/product08.png" alt="">
                                    </div>
                                    <div class="product-body">
                                        <p class="product-category">Category</p>
                                        <h3 class="product-name"><a href="#">product name goes here</a></h3>
                                ...
                                <div class="product-widget">
                                    <div class="product-img">
                                        <img src="<c:url value='views'/>/img/product09.png" alt="">
                                    </div>
                                    <div class="product-body">
                                        <p class="product-category">Category</p>
                                        <h3 class="product-name"><a href="#">product name goes here</a></h3>
                            ...
                            <div>
                                ...
                                <div class="product-widget">
                                    <div class="product-img">
                                        <img src="<c:url value='views'/>/img/product03.png" alt="">
                                    </div>
                                    <div class="product-body">
                                        <p class="product-category">Category</p>
                                        <h3 class="product-name"><a href="#">product name goes here</a></h3>
                    ...
                    <div class="col-md-4 col-xs-6">
                        ...
                        <div class="products-widget-slick" data-nav="#slick-nav-4">
                            <div>
                                ...
                                <div class="product-widget">
                                    <div class="product-img">
                                        <img src="<c:url value='views'/>/img/product04.png" alt="">
                                    </div>
                                    <div class="product-body">
                                        <p class="product-category">Category</p>
                                        <h3 class="product-name"><a href="#">product name goes here</a></h3>
                                ...
                                <div class="product-widget">
                                    <div class="product-img">
                                        <img src="<c:url value='views'/>/img/product05.png" alt="">
                                    </div>
                                    <div class="product-body">
                                        <p class="product-category">Category</p>
                                        <h3 class="product-name"><a href="#">product name goes here</a></h3>
