<%-- 
    Document   : store
    Created on : Jun 12, 2020, 7:02:57 PM
    Author     : doanv
--%>
...
<html lang="en">
	<head>
		...
		<title>Luxmedia- Store máy tính phụ kiện công nghệ</title>
			...
			<div id="top-header">
				<div class="container">
					<ul class="header-links pull-left">
						<li><a href="#"><i class="fa fa-phone"></i> 0888100777</a></li>
						<li><a href="#"><i class="fa fa-envelope-o"></i> luxmedia@email.com</a></li>
						<li><a href="#"><i class="fa fa-map-marker"></i> 290 Nguyễn Trãi, Thanh Xuân, Hà Nội</a></li>
					</ul>
					...
					<div class="row">
						...
						<div class="col-md-3">
							<div class="header-logo">
								<a href="#" class="logo">
									<img src="<c:url value='views'/>/img/logo.png" alt="">
								</a>
							</div>
						</div>
						<!-- /LOGO -->
...
<!--											<span class="sale">-30%</span>-->
									...
									<div class="product-body">
<!--										<p class="product-category">Category</p>-->
										<h3 class="product-name"><a href="viewProduct?idProduct=${p.idProduct}">${p.tenSanPham}</a></h3>
                                                                                <h4 class="product-price"><fmt:formatNumber>${p.gia}</fmt:formatNumber> VND</h4>
										...
										<div class="product-btns">
											...
											<button class="add-to-compare"><i class="fa fa-exchange"></i><span class="tooltipp">add to compare</span></button>
                                                                                        <a class="quick-view" href="viewProduct.htm?idProduct=${p.idProduct}"> <i class="fa fa-eye"></i></a>
